<div id="rootwizard">
    ...
    <div class="tab-content">
        <div class="tab-pane" id="tab1">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('id_doctor') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('id_consulting_room') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('genre') ? ' has-error' : '' }}">
        ...
        <div class="tab-pane" id="tab2" disabled="disabled">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group{{ $errors->has('colony') ? ' has-error' : '' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group{{ $errors->has('no_exterior') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('no_interior') ? ' has-error' : '' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group{{ $errors->has('scholarship') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('civil_status') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('religion') ? ' has-error' : '' }}">
        ...
        <div class="tab-pane" id="tab3" disabled="disabled">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('diabetes') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('arterial_hypertension') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('asthma') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('cardiopathy') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('nephropathy') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('hepatopathy') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('pneumopathy') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('cancer') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('mental_diseases') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('allergic_diseases') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('endocrine_diseases') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('others_family_background') ? ' has-error' : '' }}">
                    {!! Form::label('others_family_background', 'Otras', ['class' => 'col-md-2 control-label']) !!}
        ...
        <div class="tab-pane" id="tab4" disabled="disabled">
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('diseases') ? ' has-error' : '' }}">
                    {!! Form::label('diseases', 'Enfermedades', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('previous_surgery') ? ' has-error' : '' }}">
                    {!! Form::label('previous_surgery', 'Cirugías Previas', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('hospitalizations') ? ' has-error' : '' }}">
                    {!! Form::label('hospitalizations', 'Hospitalizaciones', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('traumas') ? ' has-error' : '' }}">
                    {!! Form::label('traumas', 'Traumas', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('allergies') ? ' has-error' : '' }}">
                    {!! Form::label('allergies', 'Alérgias', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('transfusions') ? ' has-error' : '' }}">
                    {!! Form::label('transfusions', 'Transfusiones', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('smoking') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('alcoholism') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('addictions') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('immunizations') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('others_personal_history') ? ' has-error' : '' }}">
                    {!! Form::label('others_personal_history', 'Otros', ['class' => 'col-md-2 control-label']) !!}
        ...
        <div class="tab-pane" id="tab5" disabled="disabled">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('menarca') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('menstrual_rhythm') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('g') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('p') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('a') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('c') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('fum') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 form-group{{ $errors->has('fpp') ? ' has-error' : '' }}">
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('menopause') ? ' has-error' : '' }}">
                    {!! Form::label('menopause', 'Menopausia', ['class' => 'col-md-2 control-label']) !!}
        ...
        <div class="tab-pane" id="tab6" disabled="disabled">
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('cardiovascular_system') ? ' has-error' : '' }}">
                    {!! Form::label('cardiovascular_system', 'Sistema Cardiovascular', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('digestive_system') ? ' has-error' : '' }}">
                    {!! Form::label('digestive_system', 'Sistema Digestivo', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('respiratory_system') ? ' has-error' : '' }}">
                    {!! Form::label('respiratory_system', 'Sistema Respiratorio', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('genitourinary_system') ? ' has-error' : '' }}">
                    {!! Form::label('genitourinary_system', 'Sistema Genitourinario', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('lymphatic_system') ? ' has-error' : '' }}">
                    {!! Form::label('lymphatic_system', 'Sistema Linfohemático', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('endocrine_system') ? ' has-error' : '' }}">
                    {!! Form::label('endocrine_system', 'Sistema Endócrino', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('osteomyoarticular_system') ? ' has-error' : '' }}">
                    {!! Form::label('osteomyoarticular_system', 'Sistema Osteomioarticular', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('nervous_system') ? ' has-error' : '' }}">
                    {!! Form::label('nervous_system', 'Sistema Nervioso', ['class' => 'col-md-2 control-label']) !!}
            ...
            <div class="row">
                <div class="col-md-12 form-group{{ $errors->has('integumentary_system') ? ' has-error' : '' }}">
                    {!! Form::label('integumentary_system', 'Sistema Tegumentario', ['class' => 'col-md-2 control-label']) !!}
